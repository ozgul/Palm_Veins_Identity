...
# to be used for global update of pheromone values is a dict of dict
    ...
    for _ in range(80):
        ...
        updated_ant_position, updated_pheromone_matrix, updated_visited_pixels = move_ant(ant_position_copy, pheromone_matrix_copy, heuristic_matrix, visited_pixels_copy)
        ...
        pheromone_matrix = global_pheromone_update(pheromone_matrix_copy, visited_pixels)
